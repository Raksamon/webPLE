                        ...
                        <form action="comArch/confirm">
                            ...
                            <div class="container">
                                <ul class="ks-cboxtags">
                                    <li><input type="checkbox" id="checkboxOne" value="Advanced Computer Engineering Laboratory" checked><label for="checkboxOne">Advanced Computer Engineering Laboratory</label></li>
                                    <li><input type="checkbox" id="checkboxTwo" value="Computer Hardware Design"><label for="checkboxTwo">Computer Hardware Design</label></li>
