                        ...
                        <form action="parallel">
                            ...
                            <div class="container">
                                <ul class="ks-cboxtags">
                                    <li><input type="checkbox" id="checkboxOne" value="Parallel Processing and Distributed Systems"><label for="checkboxOne">Parallel Processing and Distributed Systems</label></li>
                                </ul>
                            </div>
