                        ...
                        <form action="ComGraph">
                            ...
                            <div class="container">
                                <ul class="ks-cboxtags">
                                    <li><input type="checkbox" id="checkboxOne" value="Digital Image and Video Compression"><label for="checkboxOne">Digital Image and Video Compression</label></li>
                                    <li><input type="checkbox" id="checkboxTwo" value="Machine Vision"><label for="checkboxTwo">Machine Vision</label></li>
                                    <br>
                                    <li><input type="checkbox" id="checkboxThree" value="Game Development"><label for="checkboxThree">Game Development</label></li>
                                    <li><input type="checkbox" id="checkboxFour" value="Computer Graphics"><label for="checkboxFour">Computer Graphics</label></li>
                                </ul>
                            </div>
                            <br><br><br><br>
